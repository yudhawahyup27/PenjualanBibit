...
<div class="container-fluid px-4">
    ...
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item"><a href="/pemilik/produkbibit">Dashboard</a></li>
        <li class="breadcrumb-item "><a href="/pemilik/produkbibit">Produk Bibit</a></li>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form method="post" action="<?= url('/') ?>/pemilik/produkbibit/ubah/{{$get_produk->id_produk}}"  enctype="multipart/form-data">
                {{@csrf_field()}}
                <div class="mb-3">
