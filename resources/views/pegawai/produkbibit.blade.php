...
<div class="container-fluid px-4">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <a class="btn btn-primary" href="<?= url('/') ?>/pegawai/bibit/tambah"><i class="fa-solid fa-plus"></i> Tambah Data</a>
                ...
                <table class="table table-responsive" id="datatablesSimple">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?= url('/') ?>/pegawai/bibit/ubah/{{$key->id_produk}}" class="btn btn-warning"><i class="fa-solid fa-pen-to-square"></i></a>
                                <a href="<?= url('/') ?>/pegawai/bibit/hapus/{{$key->id_produk}}" class="btn btn-danger"><i class="fa-solid fa-trash"></i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
