        ...
        <div class="row mt-5 mb-5">
            ...
            <div class="col-md-6">
                ...
                <div class="prod_info">
                    ...
                    <table class="table table-borderless">
                        <tbody>
                            <form id="orderForm"
                                    ...
                                    <td>
                                        <select name="pengiriman" class="form-control" required>
                                            ...
                                            @foreach ($kecamatan as $key)
                                                <option value="{{ $key->kecamatan_id }}">{{ $key->kecamatan_name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </td>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <button type="submit" name="action" value="cart" class="btn btn-primary">Tambah
                                            Ke Keranjang</button>
                                        <button type="submit" name="action" value="beli_langsung"
                                            class="btn btn-primary">Beli Langsung</button>
                                    </td>
                                </tr>
                            </form>
                        </tbody>
                    ...
                    <div>
                        <p>*Pastikan alamat yang diisi sesuai dengan alamat yang diterima. Kesalahan pengiriman bukan
                            tanggung jawab ecommerce</p>
                    </div>
                </div>
            </div>
        </div>
