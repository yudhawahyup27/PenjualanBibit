    ...
    <form action="{{ url('/pelanggan/bibitborongan/checkout') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="mx-4 my-2">
            <div class="mb-3">
                ...
                <select name="produkborong_select" id="produkborong_select" class="form-select">
            ...
            <div class="my-3">
                ...
                <input name="harga_bibit" id="harga_bibit" class="form-control" type="text" placeholder="Harga" disabled>
            </div>
            <div class="mb-3">
                <label for="tanggal_tanam" class="form-label">Tanggal Tanam</label>
                <input name="tanggal_tanam" type="date" class="form-control" id="tanggal_tanam" placeholder="Tanggal Tanam">
            </div>
            <div class="custom-select-container">
                <label for="lahan_select" class="form-label">Luas Lahan</label>
                <select name="lahan_select" id="lahan_select" class="form-select">
                    <option selected disabled>Select an option or type</option>
                    <optgroup label="m2">
            ...
            <div class="my-3">
                ...
                <input name="jumlah_perbatang" id="jumlah_perbatang" class="form-control" type="text" placeholder="">
            </div>
            <div class="my-3">
                <label for="total" class="form-label">Total Bayar</label>
                <input name="total" id="total" class="form-control" type="text" placeholder="" readonly>
            </div>
            <div class="my-3">
                <label for="bukti_pembayaran" class="form-label">Bukti Pembayaran</label>
                <div class="custom-file">
                    <input name="bukti_pembayaran" type="file" class="custom-file-input" id="customFile">
